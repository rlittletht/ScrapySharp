namespace ScrapySharp.Network
{
    public static class FakeUserAgents
    {
        ...
        public static readonly FakeUserAgent Chrome24 = new FakeUserAgent("Chrome", "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/24.0.1312.57 Safari/537.17");
        ...
        public static readonly FakeUserAgent ModernEdge = new FakeUserAgent("Edge", "Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 6.2; WOW64; Trident/7.0; .NET4.0C; .NET4.0E; .NET CLR 2.0.50727; .NET CLR 3.0.30729; .NET CLR 3.5.30729; Zoom 3.6.0)");
    }
}